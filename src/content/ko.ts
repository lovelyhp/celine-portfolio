    ...
    slides: [
      ...
      },
      {
        ...
        body: [
          ...
          '저는 총괄 비서 Céline에게 묻습니다. "오늘 파트너 협상 포인트는 뭐야?" 예전이라면 모든 메일을 열고, 협정 폴더를 뒤지고, 밸런스를 일일이 계산했을 것입니다. 지금은 제 비서들이 각자 자기 자리를 지키고, 저는 `무엇을, 누구에게, 어떤 순서로` 물어볼지만 결정합니다.',
        ],
        imageSrc: null,
      ...
      },
      {
        ...
        body: [
          ...
          },
          {
            h: '시간이 생겼다는 것의 진짜 의미',
            p:
              '단순 반복적인 업무 노동에서 벗어나니 회사의 기획과 전략에 집중할 수 있게 되었습니다. 퇴근 후 대학원 수업과 AI 학회에도 참여하고 있습니다. OIA Rush가 없었다면 시도조차 못 했을 일상입니다.',
          },
        ],
        imageSrc: null,
