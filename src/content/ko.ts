...
export const ko = {
  ...
  about: {
    ...
    title: 'About',
    body: [
      '연세대학교에서 해외 대학들과의 학술교류 및 교환학생 선발 등 해외파견 프로그램을 담당하고 있습니다. 동시에 연세대학교 인공지능융합대학원에서 인공지능컴퓨팅 석사과정에 재학 중입니다.',
      '프랑스어를 전공한 평범한 교직원이 현장의 단순 반복 업무를 AI로 바꾸기 시작한 것은 불과 1년 전이었습니다. Flask·GAS·D3.js·React로 직접 도구를 만들고, 최근에는 Claude Code로 6층 빌딩 구조의 "OIA 자동화 사무실"을 구축해 15명의 AI 비서와 고양이 유부가 사무실을 지키고 있습니다.',
      '수많은 아이디어가 메모장에만 남는 걸 견디지 못합니다. "이게 될까?" 싶던 것을 설계하고, 실제 숫자로 증명해 내는 것을 좋아합니다. 조직의 일하는 방식 자체를 바꾸는 실험을 매일 시도합니다.',
  ...
  oiaBuilding: {
    ...
    slides: [
      ...
      },
      {
        ...
        body: [
          '매일 오전 9시, 메일함엔 새 메일이 끊임없이 쌓였습니다. 수 백개의 해외대학 파트너들과 학생들의 문의가 넘쳐났고, 한국어·영어·프랑스어가 섞인 메일을 일일이 읽느라 기획과 전략 업무는 언제나 뒷전이었습니다.',
          '행정 민원 응대 히스토리와 다양한 업무 데이터들이 제각기 여러 개의 엑셀·문서·메일에 흩어져, 한 건을 처리할 때마다 수십 개의 창을 오가야 했습니다. 하루 일과의 대부분이 단순 반복 업무로 사라졌고, 정작 회사의 기획·전략 업무를 할 시간은 남지 않았습니다.',
        ],
        imageSrc: null,
      ...
      },
      {
        ...
        body: [
          ...
          '이메일 분류 트리아지, ECTS 자동 환산 시스템, D3.js 대시보드, 노미네이션 관리 GAS 웹앱, 증명서 자동 발급 시스템... 저의 실험이 성공할 때마다 성과는 눈에 띄게 늘어났습니다.',
        ],
        imageSrc: null,
      ...
      },
      {
        ...
        body: [
          ...
          '폴더 = 부서, 파일 변경 이벤트 = 비서 상태 변화, 전체 활동량 = 유부의 순찰 속도. 추상적 이벤트를 눈에 보이는 귀여움으로 탄생시켰습니다. AI를 도구가 아니라 동료로 대하고 싶은 마음을 담았습니다.',
        ],
        imageSrc: null,
      ...
      },
      {
        ...
        body: [
          '오후 3시, 1층의 Léa가 프랑스 IP Paris에서 날아온 MoU 갱신 초안을 검토하고, 2층의 Mail은 154통의 이메일을 분류 중이고, 3층의 Nomi는 파리정치대학 노미네이션 8건을 처리하고, 4층 Solène는 교환 밸런스를 업데이트하고 있습니다. 명예회장 유부는 `peak` 모드를 선언하고 꼭대기 층에서 열심히 캣휠을 탑니다.',
          '저는 그저 5층의 총괄 비서 Céline에게 묻습니다. "오늘 IP Paris 관련 협상 포인트는 뭐야?" 예전이라면 모든 메일을 열고, 협정 폴더를 뒤지고, 밸런스를 일일이 계산해보았을 것입니다. 지금은 제 비서들이 각자 자기 폴더를 지키고, 저는 `무엇을, 누구에게, 어떤 순서로` 물어볼지만 결정합니다.',
        ],
        imageSrc: null,
      ...
      },
      {
        ...
        body: [
          '저는 개발자는 아니라서, 멋진 코드나 스킬을 사용할 줄은 모릅니다. 대신 "무엇이 문제인지" 정의하고, "어떻게 해결해야 하는지" 방법을 설계하고, "다른 곳에 응용할 수 있는지"를 바라보는 능력을 갖추고 있습니다.',
        ...
        body: [
          {
            ...
            p:
              'MCP를 설계하면서 기존 업무와 대학원을 병행해야 했기 때문입니다. 그러나 OIA 빌딩이 세워지자, 지금 이 순간도 제 비서들은 원고를 검수하고, 메일 초안을 쓰고, 데이터를 분석하고 있습니다. 저는 비효율의 늪에서 벗어나, 이 모든 것을 다스리는 건물주가 되었습니다.',
          },
          {
            h: '시간이 생겼다는 것의 진짜 의미',
            p:
              '단순 반복적인 업무 노동에서 벗어나니 회사의 기획과 전략에 집중할 수 있게 되었습니다. 국제처 홈페이지 개편, 협정교 DB 구축, 퇴근 후 대학원 수업과 AI 학회에도 참여하고 있습니다. OIA Rush가 없었다면 시도조차 못 했을 일상입니다.',
          },
        ],
        imageSrc: null,
      ...
      },
      {
        ...
        scenes: [
          ...
          '정시 퇴근을 하고 집에 돌아왔을 때, 유부가 평소보다 일찍 저를 반겼습니다.',
