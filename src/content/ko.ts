  ...
  oiaBuilding: {
    ...
    slides: [
      ...
      },
      {
        ...
        body: [
          '저는 사무행정직군이지만, AI와의 페어 플레이를 통해 주어진 상황에서 문제를 발견하고 → 문제를 정의 내리고 → 문제를 해결할 시스템을 만들어 → 문제를 개선하는 능력을 갖추고 있습니다. 저는 코드나 스킬을 암기하지 않습니다. 대신 "무엇이 문제인지", "어떻게 작동해야 하는지", "지금 어디가 어색한지"를 정확히 짚어내는 안목이 있을 뿐입니다.',
