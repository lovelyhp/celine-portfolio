...
export const ko = {
  meta: {
    ...
    tagline: '반복되는 일상 속, 인공지능 한 방울로 미래를 여는 기획자',
    subtitle:
  ...
  oiaBuilding: {
    ...
    year: '2026',
    title: 'OIA 자동화 사무실',
    subtitle: '15명의 AI 비서가 작동하는 가상 6층 빌딩',
    stack: ['Claude Code', 'Flask', 'GAS', 'Claude API', 'D3.js'],
    slides: [
      {
        kind: 'cover',
        heading: 'OIA 자동화 사무실',
        sub: '15명의 AI 비서가 작동하는 가상 6층 빌딩',
        body:
      ...
      },
      {
        ...
        body: [
          '매일 오전 9시, 받은 메일함엔 최소 100통의 새 이메일이 쌓여 있었습니다. 105곳이 넘는 해외 파트너 대학들과 국내외 수백 명의 학생들의 문의가 넘쳐나고, 한국어·영어·프랑스어가 섞인 메일들 속에서 하루라도 대응이 늦어지면 미확인 메일은 200통 넘게 불어났습니다.',
          '한 학기 200건 이상의 ECTS 성적 환산, 매 학기 교환학생 선발과 대학 배정, 비슷하지만 케이스마다 미묘하게 다른 FAQ 응대. 협정교 정보·학생 데이터·과거 케이스는 여러 엑셀·문서·메일에 흩어져, 한 건을 처리할 때마다 수십 개의 창을 오갔습니다.',
      ...
      },
      {
        ...
        body: [
          '처음부터 모든 것을 자동화할 생각은 없었습니다. 그저 조금 더 나은 환경을 만들고 싶었습니다.',
      ...
      },
      {
        ...
        body: [
          '구축한 시스템이 많아질수록 "이 일에는 어떤 툴을 쓰지?"를 판단하는 것 자체가 부담이 되기 시작했습니다. 실험은 성공했지만 제각각의 폴더, 각자의 실행 방식, 서로 다른 업데이트 주기를 가졌습니다.',
          '그러던 어느 날 하나의 생각이 스쳤습니다. 업무들을 한 곳에 모아볼까? 그리고 이왕이면, 시뮬레이션 게임처럼 만들어볼까?',
        ],
        imageSrc: null,
      ...
      },
      {
        ...
        body: [
          ...
          '이건 장식이 아니라 설계된 게임입니다. 폴더 = 부서, 파일 변경 이벤트 = 비서들의 상태 변화, 전체 활동량 = 유부의 순찰 속도. 시스템의 추상적 이벤트를 눈에 보이는 귀여움으로 탄생시켰습니다.',
      ...
      },
      {
        ...
        body: [
          '저는 행정직군의 대학 교직원이지만, AI와의 페어 플레이를 통해 주어진 상황에서 문제를 발견하고 → 문제를 정의 내리고 → 문제를 해결할 시스템을 만들어 → 문제를 개선하는 능력을 갖추고 있습니다. 저는 코드나 스킬을 암기하지 않습니다. 대신 "무엇이 문제인지", "어떻게 작동해야 하는지", "지금 어디가 어색한지"를 정확히 짚어내는 안목이 있을 뿐입니다.',
      ...
      },
      {
        ...
        scenes: [
          '마크롱 대통령 방문 당일. 저는 의전 현장에 집중할 수 있었습니다. 그날 아침에도 제 AI 비서가 90통 넘는 메일을 저 대신 분류해두었기 때문입니다.',
